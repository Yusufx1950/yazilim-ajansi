      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverPadding(
            padding: const EdgeInsets.symmetric(horizontal: 24),
            sliver: SliverGrid(
              // MaxCrossAxisExtent kullanarak kartların maksimum genişliğini sınırla
              gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                maxCrossAxisExtent: 350, // Her kart max 350px genişliğinde
                mainAxisSpacing: 16,
                crossAxisSpacing: 16,
                childAspectRatio: 0.8, // Biraz daha kareye yakın oran
              ),
